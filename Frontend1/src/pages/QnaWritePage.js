        ...
        <p className="text-gray-400">
          ...
          <div className="flex float-right">
            <Link
              to="/main/qnalist"
              button
              className="py-2.5 bg-green-500 hover:bg-green-700 text-white text-sm font-semibold px-3 rounded transition"
            >
              돌아가기 ❎
            </Link>
            &nbsp;
            <Link
              to="/main/qnalist"
              button
              className=" py-2.5  bg-blue-500 hover:bg-blue-700 text-white text-sm font-semibold px-3 rounded transition"
