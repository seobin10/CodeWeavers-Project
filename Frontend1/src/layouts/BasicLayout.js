...
const BasicLayout = () => {
  ...
  const [openEnrollmentMenu, setOpenEnrollmentMenu] = useState(false); // 수강신청 드롭다운 상태
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <div className="flex flex-1">
            ...
            <div className="flex flex-col mt-2 mb-2">
              ...
              {openEnrollmentMenu && (
                <div className="pl-8 space-y-3 text-sm mt-5">
                  <Link to="/main/enrollment" className="hover:underline block">
                    📋 수강신청 목록
                  </Link>
        ...
        {/* 오른쪽 콘텐츠 영역 */}
        <main className="p-8 bg-white bg-opacity-85 shadow-md w-full flex-1 pb-16">
          <Outlet />
        </main>
      </div>
      ...
      <footer className="bg-blue-900 text-white text-center py-4 text-sm w-full mt-auto">
        <div>
          96121 서울특별시 한국구 한국산로 12(한국동) 이온대학교 02-123-1234
          webmaster@eon.ac.kr
          <br />
