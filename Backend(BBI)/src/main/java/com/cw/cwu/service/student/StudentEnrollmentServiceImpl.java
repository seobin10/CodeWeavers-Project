...
public class StudentEnrollmentServiceImpl implements StudentEnrollmentService {
    ...
    public void applyToClass(EnrollmentRequestDTO requestDTO) {
        ...
        if (enrollmentRepository.existsByStudentAndEnrolledClassEntity(student, classEntity)) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "이미 신청한 강의입니다.");
        }
        ...
        if (classEntity.getCourse().getDepartment() != null &&
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "해당 학과의 학생만 신청할 수 있습니다!");
        }
        ...
        if (CourseType.MAJOR.equals(classEntity.getCourse().getType()) && majorCount >= 4) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "한 학기에 최대 4개의 전공 과목만 신청할 수 있습니다!");
        }
        ...
        if (totalCredits + classEntity.getCourse().getCredit() > 18) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "최대 수강 가능 학점(18학점)을 초과하였습니다!");
        }
        ...
        if (enrollmentRepository.existsByStudentAndTimeConflict(
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "이미 같은 시간대에 신청한 강의가 있습니다!");
        }
        ...
        if (studentYear < courseYear) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "본인 학년보다 높은 학년의 강의는 신청할 수 없습니다!");
        }
