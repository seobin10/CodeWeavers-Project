      ...
      <div>
        <table className="table-auto border-collapse w-full">
          <thead className="bg-blue-800 text-white">
            <tr>
              <th className="border border-blue-800 border-x-0 px-4 py-2">번호</th>
              <th className="border border-blue-800 border-x-0 px-4 py-2">제목</th>
              <th className="border border-blue-800 border-x-0 px-4 py-2">작성자</th>
              <th className="border border-blue-800 border-x-0 px-4 py-2">작성일</th>
              <th className="border border-blue-800 border-x-0 px-4 py-2">조회수</th>
            </tr>
          </thead>
          <tbody>
                ...
                return (
                  <tr key={i} className={cellStyle}>
                    <td className="border border-gray-400 border-x-0 px-4 py-2">
                      {notice.pin === 1 ? "\u{1F4CC}" : firstItem + i + 1 - pinned.length}
                    </td>
                    <td className={notice.pin === 1 ? `font-bold text-left border border-gray-400 border-x-0 px-4 py-2` : `text-left border border-gray-400 border-x-0 px-4 py-2`}>
                      <Link
                        to="/main/noticedata"
                        state={{
                    ...
                    <td className="border border-gray-400 border-x-0 px-4 py-2">관리자</td>
                    <td className="border border-gray-400 border-x-0 px-4 py-2">{notice.noticeDate}</td>
                    <td className="border border-gray-400 border-x-0 px-4 py-2">{notice.viewCount}</td>
                  </tr>
                );
              })
            ) : (
