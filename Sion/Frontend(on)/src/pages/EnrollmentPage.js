    ...
    <div className="max-w-7xl mx-auto p-2 bg-slate-50 bg-opacity-40 shadow-md mt-3 rounded-md">
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-3 gap-4 mb-4">
          <select
            className="bg-blue-50 border p-2 rounded w-full focus:outline-none focus:ring-1"
        ...
        <div className="grid grid-cols-4 gap-4 items-center">
          <div className="col-span-4 relative w-full">
            <input
              type="text"
              className="bg-blue-50 border p-2 rounded w-full focus:outline-none focus:ring-2"
              placeholder="강의명 검색"
              value={searchQuery}
