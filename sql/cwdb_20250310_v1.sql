...
CREATE TABLE `grades` (
  ...
  `grade_grade` char(2) DEFAULT NULL,
  PRIMARY KEY (`grade_id`),
  KEY `enrollment_id` (`enrollment_id`),
  CONSTRAINT `grades_ibfk_1` FOREIGN KEY (`enrollment_id`) REFERENCES `enrollments` (`enrollment_id`) ON DELETE CASCADE,
  CONSTRAINT `grades_chk_1` CHECK ((`grade_grade` in (_utf8mb4'A+',_utf8mb4'A0',_utf8mb4'B+',_utf8mb4'B0',_utf8mb4'C+',_utf8mb4'C0',_utf8mb4'D+',_utf8mb4'D0',_utf8mb4'F')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-10 15:36:14
